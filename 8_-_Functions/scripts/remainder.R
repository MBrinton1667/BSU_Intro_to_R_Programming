...
# the remainder (or whatever is left over/can't be divided without a decimal) is returned. 
# Imagine that you usually want to know the remainder
...
#   Ex: 7 %% 4 evaluates to 3. 4 only goes into 7 once, with 3 left over.
#
